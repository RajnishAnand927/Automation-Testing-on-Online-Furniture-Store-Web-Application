...
{
redirectWithFlash($_SERVER['REQUEST_URI'], 'error', 'Brand image has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
else
{
...
redirectWithFlash($_SERVER['REQUEST_URI'], 'success', 'Brand image updated successfully.');
