...
$query->bindParam(':scname',$scname,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    redirectWithFlash('add-subcategory.php', 'success', 'Subcategory added successfully.');
  }
  else
    {
         redirectWithFlash('add-subcategory.php', 'error', 'Something went wrong. Please try again.');
    }
