...
{
redirectWithFlash('add-products.php', 'error', 'Product image has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
if(!in_array($extension1,$allowed_extensions))
{
redirectWithFlash('add-products.php', 'error', 'Product image 1 has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
if(!in_array($extension2,$allowed_extensions))
{
redirectWithFlash('add-products.php', 'error', 'Product image 2 has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
if(!in_array($extension3,$allowed_extensions))
{
redirectWithFlash('add-products.php', 'error', 'Product image 3 has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
else
{
...
$query->bindParam(':img3',$propic3,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    redirectWithFlash('add-products.php', 'success', 'Product detail added successfully.');
  }
  else
    {
         redirectWithFlash('add-products.php', 'error', 'Something went wrong. Please try again.');
    }
