...
$chngpwd1->execute();
redirectWithFlash('login.php', 'success', 'Your password has been changed successfully.');
}
else {
redirectWithFlash('forgot-password.php', 'error', 'Email address or mobile number is invalid.'); 
}
}
...
function valid()
{
var form = document.forms.chngpwd;
var errorBox = document.getElementById('admin-forgot-password-error');
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="#" id="login" method="post" name="chngpwd" onsubmit="return valid();">
                            ...
                            <p id="admin-forgot-password-error" class="flash-inline-error"></p>
                                </div>
