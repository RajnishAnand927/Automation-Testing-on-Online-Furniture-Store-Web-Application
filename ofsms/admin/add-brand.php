...
{
redirectWithFlash('add-brand.php', 'error', 'Logo has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
else
{
...
$query->bindParam(':logo',$logo,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    redirectWithFlash('add-brand.php', 'success', 'Brand added successfully.');
  }
  else
    {
         redirectWithFlash('add-brand.php', 'error', 'Something went wrong. Please try again.');
    }
