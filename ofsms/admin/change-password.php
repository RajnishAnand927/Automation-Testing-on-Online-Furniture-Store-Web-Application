...
redirectWithFlash('change-password.php', 'success', 'Your password has been changed successfully.');
} else {
redirectWithFlash('change-password.php', 'error', 'Your current password is incorrect.');
...
function checkpass()
{
var errorBox = document.getElementById('admin-change-password-error');
                             ...
                             <div class="row">
                               ...
                               <form name="changepassword" method="post" onsubmit="return checkpass();" action="">
                                ...
                                <div class="form-group-inner">
                                 ...
                                 <p id="admin-change-password-error" class="flash-inline-error"></p>
                                  </div>
                                 </div>
                                 </div>
