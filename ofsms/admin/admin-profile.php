...
if($query -> rowCount() > 0)
   {
    redirectWithFlash('admin-profile.php', 'success', 'Profile updated successfully.');
  }
  else
    {
        redirectWithFlash('admin-profile.php', 'error', 'No changes were saved. Please try again.');
