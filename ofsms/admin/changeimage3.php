...
{
redirectWithFlash($_SERVER['REQUEST_URI'], 'error', 'Product image has invalid format. Only jpg, jpeg, png and gif are allowed.');
}
else
{
...
redirectWithFlash($_SERVER['REQUEST_URI'], 'success', 'Product image updated successfully.');
