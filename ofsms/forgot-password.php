...
$chngpwd1->execute();
redirectWithFlash('signup.php', 'success', 'Your password has been changed successfully.');
}
else {
...
function valid()
{
var errorBox = document.getElementById('forgot-password-error');
	 ...
	 <div class="container">
		 ...
		 <div class="col-md-6 log">			 
				 ...
				 <form action="" method="post" name="chngpwd" onSubmit="return valid();">
                     ...
                     <p id="forgot-password-error" class="flash-inline-error"></p>				
